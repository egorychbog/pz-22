...
async function getAllPosts() {
    // покзываем индикатор загрузки с анимацией пульсации
    resultDiv.innerHTML =
    ...
    try {
        ...
        // проходим по первым 10 постам и формируем HTML для каждого
        ...
        // вставляем сформированный HTML в блок результатов
...
/*
  асинхронная функция для создания нового поста (POST-запрос)
  используется при нажатии на кнопку "Отправить POST-запрос"
  отправляет данные из полей ввода на сервер
 */
